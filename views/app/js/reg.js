        ...
        if (user !='' && pass !='' && pass_dos !='' && email !='') {
            if (pass == pass_dos) {
                ...
                connect.send(form);
                            ...
                            result +=' <button type="button" class="close" data-dismiss="alert">x</button>';
                            result +='<h4>ERROR</h4>';
                            result +='<p><strong>Las contraseñas no coinciden.</strong>';
                            result +='</p>';
                            result +='</div>'; 
                            __('_AJAX_REG_').innerHTML = result; 
            }
            ...
            result +=' <button type="button" class="close" data-dismiss="alert">x</button>';
            result +='<h4>ERROR</h4>';
            result +='<p><strong>los terminos y condiciones deben ser aceptados.</strong>';
            result +='</p>';
            result +='</div>'; 
            __('_AJAX_REG_').innerHTML = result; 
    }
